...
namespace MMT.Controllers
{
    ...
    public class BookingsController : Controller
    {
        ...
        public BookingsController(PackageDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("BookingID,PackageName,NumberofPersons,JourneyDate,email,city,PaymentMethod,Amount,status")] Booking booking)
        {
